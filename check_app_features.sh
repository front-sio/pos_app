...
print_step "8. Network Connectivity Monitoring (UPDATED)"
echo "   - Turn off WiFi/Mobile Data"
echo "   - Verify offline placeholder appears immediately"
echo "   - Check English messages: 'No Internet Connection'"
echo "   - Click 'Try Again' (Retry) button"
echo "   - Click 'Connection Tips' for troubleshooting tips"
echo "   - Turn on WiFi/Mobile Data"
echo "   - Verify green 'Connection restored!' notification"
echo "   - Verify you return to the same page you were on"
ask_confirmation "Does network connectivity monitoring work correctly?"
